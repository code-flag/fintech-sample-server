export const paymentEmailResponse = (data) => {
  return  `
		...
		<tbody>
			...
			<tr style="height: 300px;">
				<td align="left" style="border: none;
                    ...
                    <b> Regards <br> Berenia Academy</b>
			...
			<tr style="display: inline-block;">
				<td style="height: 150px;
					...
					<h2 style="text-align: left;
							align-items: center;">
						Web Development Bootcamp Module #2 : This bootcamp introduce you to more advance web devlopment tools.
					...
					style="text-align: justify-all;
							...
							font-size: 15px;
							padding-bottom: 12px;">
                            After the solid foundation of web development, we encourage you to proceed to our module #2 of web development training which specifically deals with front-end framework such as react, vue and angular.
					</p>
					<p>
						<a href=
